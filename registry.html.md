...
| [bfcl@1.0](https://harborframework.com/registry/bfcl/1.0) | `bfcl_1_0` | Berkeley Function-Calling Leaderboard: 3,641 function calling tasks for evaluating LLM tool use capabilities across simple, multiple, parallel, and irrelevance categories. | 3641 |
| [bfcl_parity@1.0](https://harborframework.com/registry/bfcl_parity/1.0) | `bfcl_parity_1_0` | BFCL parity subset: 123 stratified sampled tasks for validating Harbor adapter equivalence with original BFCL benchmark. | 123 |
| [bigcodebench-hard-complete@1.0.0](https://harborframework.com/registry/bigcodebench-hard-complete/1.0.0) | `bigcodebench_hard_complete_1_0_0` | BigCodeBench-Hard complete benchmark adapter for Harbor - challenging Python programming tasks with reward-based verification | 145 |
...
| [deveval@1.0](https://harborframework.com/registry/deveval/1.0) | `deveval_1_0` | DevEval benchmark: comprehensive evaluation of LLMs across software development lifecycle (implementation, unit testing, acceptance testing) for 21 real-world repositories across Python, C++, Java, and JavaScript | 63 |
...
| [featurebench@1.0](https://harborframework.com/registry/featurebench/1.0) | `featurebench_1_0` | FeatureBench full split: 200 feature-implementation tasks across 24 Python repos. 7 tasks require Ampere+ GPU. Original benchmark: [link](https://github.com/LiberCoders/FeatureBench.) Adapter: [link](https://github.com/harbor-framework/harbor/pull/875.) | 200 |
| [featurebench-lite@1.0](https://harborframework.com/registry/featurebench-lite/1.0) | `featurebench_lite_1_0` | FeatureBench lite split: 30 feature-implementation tasks (26 lv1 + 4 lv2) across Python repos. Original benchmark: [link](https://github.com/LiberCoders/FeatureBench.) Adapter: [link](https://github.com/harbor-framework/harbor/pull/875.) | 30 |
| [featurebench-lite-modal@1.0](https://harborframework.com/registry/featurebench-lite-modal/1.0) | `featurebench_lite_modal_1_0` | FeatureBench lite split for Modal: 30 feature-implementation tasks with gpus=1 for GPU tasks (7/30). Use with -e modal. Original benchmark: [link](https://github.com/LiberCoders/FeatureBench.) | 30 |
| [featurebench-modal@1.0](https://harborframework.com/registry/featurebench-modal/1.0) | `featurebench_modal_1_0` | FeatureBench full split for Modal: 200 feature-implementation tasks with gpus=1 for GPU tasks (44/200). Use with -e modal. Original benchmark: [link](https://github.com/LiberCoders/FeatureBench.) | 200 |
| [financeagent@public](https://harborframework.com/registry/financeagent/public) | `financeagent_public` | Finance Agent is a tool for financial research and analysis that leverages large language models and specialized financial tools to answer complex queries about companies, financial statements, and SEC filings.Original benchmark: [link](https://github.com/vals-ai/finance-agent) | 50 |
...
| [gso@1.0](https://harborframework.com/registry/gso/1.0) | `gso_1_0` | GSO: 102 software optimization tasks focusing on performance improvement. | 102 |
...
| [labbench@1.0](https://harborframework.com/registry/labbench/1.0) | `labbench_1_0` | LAB-Bench FigQA: 181 scientific figure reasoning tasks in biology from Future-House LAB-Bench. | 181 |
...
| [legacy-bench@1.0](https://harborframework.com/registry/legacy-bench/1.0) | `legacy_bench_1_0` | A benchmark for evaluating AI agents on legacy code maintenance and modernization tasks across multiple language families including COBOL, Java 7, C, Fortran, and Assembly. | 10 |
...
| [medagentbench@1.0](https://harborframework.com/registry/medagentbench/1.0) | `medagentbench_1_0` | MedAgentBench: 300 patient-specific clinically-derived tasks across 10 categories in a FHIR-compliant interactive healthcare environment. | 300 |
| [ml-dev-bench@1.0](https://harborframework.com/registry/ml-dev-bench/1.0) | `ml_dev_bench_1_0` | ML-Dev-Bench: A benchmark for testing AI agents on machine learning development tasks including model implementation, training, debugging, and optimization. | 33 |
...
| [openthoughts-tblite@2.0](https://harborframework.com/registry/openthoughts-tblite/2.0) | `openthoughts_tblite_2_0` | OpenThoughts-TBLite: A difficulty-calibrated benchmark of 100 tasks for building terminal agents. By OpenThoughts Agent team, Snorkel AI, Bespoke Labs. | 100 |
| [otel-bench@1.0](https://harborframework.com/registry/otel-bench/1.0) | `otel_bench_1_0` | OpenTelemetry Benchmark - evaluates AI agents’ ability to instrument applications with OpenTelemetry tracing across multiple languages. | 26 |
| [pixiu@parity](https://harborframework.com/registry/pixiu/parity) | `pixiu_parity` | PIXIU: A Large Language Model, Instruction Data and Evaluation Benchmark for Finance. Original benchmark: [link](https://github.com/TheFinAI/PIXIU.) Adapter details: [link](https://github.com/laude-institute/harbor/tree/main/adapters/pixiu.) Total tasks: 435 across 29 financial NLP datasets. | 435 |
| [qcircuitbench@1.0](https://harborframework.com/registry/qcircuitbench/1.0) | `qcircuitbench_1_0` | QCircuitBench evaluates agents on quantum algorithm design using quantum programming languages. Original benchmark: [link](https://github.com/EstelYang/QCircuitBench.) | 28 |
| [quixbugs@1.0](https://harborframework.com/registry/quixbugs/1.0) | `quixbugs_1_0` | QuixBugs is a multi-lingual program repair benchmark with 40 Python and 40 Java programs, each containing a single-line defect. Tasks cover algorithms and data structures including sorting, graph, dynamic programming, math, and string/array operations. | 80 |
| [reasoning-gym-easy@parity](https://harborframework.com/registry/reasoning-gym-easy/parity) | `reasoning_gym_easy_parity` | Reasoning Gym benchmark (easy difficulty). Original benchmark: [link](https://github.com/open-thought/reasoning-gym) | 288 |
| [reasoning-gym-hard@parity](https://harborframework.com/registry/reasoning-gym-hard/parity) | `reasoning_gym_hard_parity` | Reasoning Gym benchmark (hard difficulty). Original benchmark: [link](https://github.com/open-thought/reasoning-gym) | 288 |
...
| [rexbench@1.0](https://harborframework.com/registry/rexbench/1.0) | `rexbench_1_0` | A benchmark to evaluate the ability of AI agents to extend existing AI research through research experiment implementation tasks. Original benchmark: [link](https://github.com/tinlaboratory/rexbench.) Website: [link](https://rexbench.com/.) | 2 |
| [satbench@1.0](https://harborframework.com/registry/satbench/1.0) | `satbench_1_0` | SATBench is a benchmark for evaluating the logical reasoning capabilities of LLMs through logical puzzles derived from Boolean satisfiability (SAT) problems. | 2100 |
| [scale-ai/swe-atlas-qna@1.0](https://harborframework.com/registry/scale-ai/swe-atlas-qna/1.0) | `scale_ai/swe_atlas_qna_1_0` | SWE-Atlas Codebase QnA benchmark that evaluates AI agents’ ability to comprehend and query existing codebases. | 124 |
| [scale-ai/swe-atlas-tw@1.0](https://harborframework.com/registry/scale-ai/swe-atlas-tw/1.0) | `scale_ai/swe_atlas_tw_1_0` | SWE-Atlas Test Writing benchmark that evaluates AI agents’ ability to write comprehensive unit tests. | 90 |
| [seta-env@1.0](https://harborframework.com/registry/seta-env/1.0) | `seta_env_1_0` | CAMEL SETA Environment for RL training | 1376 |
| [simpleqa@1.0](https://harborframework.com/registry/simpleqa/1.0) | `simpleqa_1_0` | SimpleQA: 4,326 short, fact-seeking questions from OpenAI for evaluating language model factuality. Uses LLM-as-a-judge grading. Source: [link](https://openai.com/index/introducing-simpleqa/) | 4326 |
...
| [spreadsheetbench-verified@1.0](https://harborframework.com/registry/spreadsheetbench-verified/1.0) | `spreadsheetbench_verified_1_0` | A benchmark evaluating AI agents on real-world spreadsheet manipulation tasks (400 tasks from verified_400). Tasks involve Excel file manipulation including formula writing, data transformation, formatting, and conditional logic. | 400 |
...
| [swe-lancer-diamond@all](https://harborframework.com/registry/swe-lancer-diamond/all) | `swe_lancer_diamond_all` | Adapter for SWE-Lancer ([link](https://github.com/openai/preparedness/blob/main/project/swelancer/README.md)). Both manager and individual contributor tasks. | 463 |
| [swe-lancer-diamond@ic](https://harborframework.com/registry/swe-lancer-diamond/ic) | `swe_lancer_diamond_ic` | Adapter for SWE-Lancer ([link](https://github.com/openai/preparedness/blob/main/project/swelancer/README.md)). Only the individual contributor SWE tasks. | 198 |
| [swe-lancer-diamond@manager](https://harborframework.com/registry/swe-lancer-diamond/manager) | `swe_lancer_diamond_manager` | Adapter for SWE-Lancer ([link](https://github.com/openai/preparedness/blob/main/project/swelancer/README.md)). Only the manager tasks. | 265 |
...
| [swebench_multilingual@1.0](https://harborframework.com/registry/swebench_multilingual/1.0) | `swebench_multilingual_1_0` | SWE-bench Multilingual extends the original Python-focused SWE-bench benchmark to support multiple programming languages. Original benchmark: [link](https://www.swebench.com/multilingual.html.) | 300 |
| [swebenchpro@1.0](https://harborframework.com/registry/swebenchpro/1.0) | `swebenchpro_1_0` | SWE-bench Pro: A multi-language software engineering benchmark with 731 instances covering Python, JavaScript/TypeScript, and Go. Evaluates AI systems’ ability to resolve real-world bugs and implement features across diverse production codebases. Original benchmark: [link](https://github.com/scaleapi/SWE-bench_Pro-os.) Adapter details: [link](https://github.com/laude-institute/harbor/tree/main/adapters/swebenchpro) | 731 |
...
| [termigen-environments@1.0](https://harborframework.com/registry/termigen-environments/1.0) | `termigen_environments_1_0` | 3,500+ verified Docker environments for training and evaluating terminal agents, spanning 11 task categories across infrastructure, data/algorithm applications, and specialized domains including software build, system administration, security, data processing, ML/MLOps, algorithms, scientific computing, and more. | 3566 |
