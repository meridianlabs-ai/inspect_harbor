...
| [abundant/swe-marathon](registry/abundant_swe_marathon.html.md) | abundant_swe_marathon | Ultra long-horizon software engineering tasks from SWE-Marathon. | 20 |
...
| [cohere/terminal_bench_aai](registry/cohere_terminal_bench_aai.html.md) | cohere_terminal_bench_aai | AAII Terminal-Bench Hard: 44 hard tasks from terminal-bench v1 (terminal-bench-core==0.1.1), used w… | 44 |
...
| [datacurve/deep-swe-1-1](registry/datacurve_deep_swe_1_1.html.md) | datacurve_deep_swe_1_1 | DeepSWE 1.1 (point release with isolated verifier environments): measuring frontier coding agents o… | 113 |
...
| [hwe-bench/hwe-bench](registry/hwe_bench.html.md) | hwe_bench | HWE-bench evaluates LLM agents on engineering-simulation tasks: the agent drives a real solver and… | 77 |
| [ibragim-badertdinov/swe-rebench-07-2026](registry/swe_rebench_07_2026.html.md) | swe_rebench_07_2026 | 111 hard SWE-rebench leaderboard tasks from the July 2026 snapshot across Go, Java, Python, Rust, a… | 111 |
...
| [nl2repobench/nl2repobench](registry/nl2repobench.html.md) | nl2repobench | Agent generates a complete, installable Python library from a single natural-language requirements… | 104 |
...
| [openai/simpleqa](registry/openai_simpleqa.html.md) | openai_simpleqa | SimpleQA: short, fact-seeking questions adversarially collected against GPT-4 to measure short-form… | 4326 |
...
| [red-hat-ai/SWE-benchify-hard](registry/red_hat_ai_swe_benchify_hard.html.md) | red_hat_ai_swe_benchify_hard | Hard subset of SWE-bench-style Go issue-resolution tasks generated by Red Hat’s SWE-benchify pipeli… | 284 |
| [red-hat-ai/haiku-hard](registry/red_hat_ai_haiku_hard.html.md) | red_hat_ai_haiku_hard | Hard subset of SWE-style Go bug-fixing tasks drawn from Red Hat-ecosystem repos (openshift, operato… | 178 |
...
| [userbench/UserBench](registry/userbench.html.md) | userbench | UserBench eval: 620 next-message tasks across 62 developers. Composer 2.5 classifies gold and predi… | 620 |
| [userbench/UserBench-train400](registry/userbench_train400.html.md) | userbench_train400 | UserBench train400 twin: the same 620 held tasks plus 400 leak-safe prior turns per developer. Comp… | 620 |
...
| [vmax/vmax-tasks](registry/vmax_tasks.html.md) | vmax_tasks | Code-transformation tasks across JavaScript projects (Docusaurus, Vue, Redux). | 1043 |
