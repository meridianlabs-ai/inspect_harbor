...
| [frontier-bench/frontier-bench](registry/frontier_bench.html.md) | frontier_bench | The frontier is wide and dynamic. Frontier-Bench measures general agent capabilities on a diverse s… | 74 |
...
| [terminal-bench/terminal-bench-3](registry/terminal_bench_3.html.md) | terminal_bench_3 | Terminal-Bench 3.0 is the third benchmark for measuring agents’ abilities to complete tasks using a… | 75 |
