...
``` bash
inspect eval inspect_harbor/infra_bench_infra_bench_v1 --model openai/gpt-5
```
...
from inspect_harbor import infra_bench_infra_bench_v1

eval(infra_bench_infra_bench_v1(), model="openai/gpt-5")
```
...
| Inspect task | `infra_bench_infra_bench_v1` |
